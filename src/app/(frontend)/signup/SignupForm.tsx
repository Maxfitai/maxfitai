            ...
            <>
              ...
              <CardContent className="space-y-6">
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input
                                  ...
                                  style={{
                                    backgroundColor:
                                      'hsl(var(--color-background) / 0.5) !important',
                                    boxShadow:
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <div className="grid grid-cols-2 gap-3">
                              <label
                                className={`flex items-center gap-2 px-4 py-2 rounded-md border cursor-pointer transition-all ${field.value === 'male'
                              ...
                              <label
                                className={`flex items-center gap-2 px-4 py-2 rounded-md border cursor-pointer transition-all ${field.value === 'female'
                                  ? 'bg-maxfit-neon-green/20 border-maxfit-neon-green shadow-[0_0_10px_rgba(0,255,170,0.3)] font-medium'
                                  : 'bg-background/50 border-border hover:border-maxfit-neon-green/50'
                                  }`}
                              >
                ...
                <div className="text-center">
                  <Link href="/login">
                    <Button variant="ghost" className="btn-outline-neon cursor-pointer">
