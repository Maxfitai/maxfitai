  ...
  return (
    <div className="md:hidden">
            ...
            <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
              {filteredTabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`inline-flex items-center justify-center ${isActive ? 'text-black' : 'text-maxfit-neon-green/80'
                        }`}
                    >
                      {tab.icon}
                    </span>
                    <span
                      className={`font-medium ${isActive ? 'text-black' : 'text-maxfit-medium-grey'}`}
                    >
                      {tab.label}
                    </span>
                  </Link>
      ...
      <Dialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <DialogContent className="bg-gradient-to-br from-gray-900/20 to-gray-800 border border-maxfit-neon-green/30 text-maxfit-white sm:max-w-[400px] items-center text-center justify-center">
          <DialogHeader>
