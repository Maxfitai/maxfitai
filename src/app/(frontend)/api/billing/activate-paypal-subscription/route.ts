...
export async function POST(req: NextRequest) {
  try {
    ...
    // Ensure we're dealing with a User object (not Admin)
    ...
    await payload.update({
      ...
      data: {
        ...
        // minutesAllowed: sessionsToSet, // Set session-based limit
        plan: plan,
    ...
    console.log(
      `Updated user ${userId} with ${callsToAdd} AI calls and ${sessionsToSet} sessions for ${plan} plan`,
    )
